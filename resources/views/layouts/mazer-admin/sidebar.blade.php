<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item @if (Route::currentRouteName() == 'admin.product.index') active @endif">
                <a href="{{ route('admin.product.index') }}" class='sidebar-link'>
                    <i class="fa fa-tachometer-alt"></i>
                    <span>Products</span>
                </a>
            </li>
            <li class="sidebar-item @if (Route::currentRouteName() == 'admin.customer.index') active @endif">
                <a href="{{ route('admin.customer.index') }}" class='sidebar-link'>
                    <i class="fa fa-tachometer-alt"></i>
                    <span>Customer</span>
                </a>
            </li>
            <li class="sidebar-item @if (Route::currentRouteName() == 'admin.vendor.index') active @endif">
                <a href="{{ route('admin.vendor.index') }}" class='sidebar-link'>
                    <i class="fa fa-tachometer-alt"></i>
                    <span>Vendor</span>
                </a>
            </li>
            <li class="sidebar-item @if (Route::currentRouteName() == 'admin.sale.index') active @endif">
                <a href="{{ route('admin.sale.index') }}" class='sidebar-link'>
                    <i class="fa fa-tachometer-alt"></i>
                    <span>Sale Invoice</span>
                </a>
            </li>
            <li class="sidebar-item @if (Route::currentRouteName() == 'admin.purchase.index') active @endif">
