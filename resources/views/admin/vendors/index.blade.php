            ...
            <div class="card">
                <nav class="navbar navbar-expand-lg navbar-light ">
                    <div class="container-fluid page-heading">
                        <a class="navbar-brand h1 " href={{ route('admin.vendor.index') }}></a>
                        <div class="justify-end ">
                            <div class="col ">
                                <a class="btn btn-sm btn-success" href={{ route('admin.vendor.create') }}>Add Vendor</a>
                            </div>
                        </div>
                    </div>
                </nav>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-small btn-danger delete_row"
                                        href="{{ URL::to('admin/vendor/' . $value->id . '/delete') }}">Delete</a>


                                    <!-- edit this shark (uses the edit method found at GET /sharks/{id}/edit -->
                                    <a style="background-color: #435ebe" class="btn btn-small btn-info"
                                        href="{{ URL::to('admin/vendor/' . $value->id . '/edit') }}">Edit
                                        this </a>
